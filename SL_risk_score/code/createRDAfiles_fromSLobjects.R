...
## For the COVID correlates project
## dated 11 Dec 2020
...
# For placebo, d57 endpoint
data_file <- "results/cvsl_riskscore_cvaucs.rds"
risk_placebo_cvaucs <- readin_SLobjects_fromFolder(data_file, trt = "placebo") 
save(risk_placebo_cvaucs, file = "results/cvsl_risk_placebo_cvaucs.rda")
