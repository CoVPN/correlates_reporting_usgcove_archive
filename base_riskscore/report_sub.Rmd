...
read.csv(here("base_riskscore", "output", "risk_vars.csv"), row.names = 1, header = TRUE) %>%
  kable(
    #format = output_type,
    booktabs = TRUE,
    linesep = "",
...
read.csv(here::here("base_riskscore", "output", "learner-screens.csv"), row.names = 1, header = TRUE) %>%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{`r here::here("base_riskscore", "output", "risk_placebo_cvaucs.png")`}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{`r here::here("base_riskscore", "output", "predProb_riskscore_plac.png")`}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{`r here::here("base_riskscore", "output", "ROCcurve_riskscore_plac.png")`}
...
read.csv(here("base_riskscore", "output", "SL_weights.csv"), row.names = 1, header = TRUE) %>%
  kable(
    booktabs = TRUE,
    linesep = "",
    caption = caption
