...
dat.mock<-read.csv(file="data_clean/janssen_pooled_mock_data_processed.csv")
...
fit2<-try.error(
   EM.cc.CPV.Probit.Small.Nonpar2.NC.SubWA.X.Short.New.COVID.E(Z,Sout.NC.All.X,WoutA.NC.All.X,S1,W,Y,X,Wu,Xu,delta1,delta2,pd2.YZXW,varlist=c("W2","W3","W4","R0MinorityInd","Region1","Region2","HighriskInd","Senior"),beta=rep(0,12)))



VE2<-integVE.COVID.E(Su,datin,varlist=c("W2","W3","W4","R0MinorityInd","Region1","Region2","HighriskInd","Senior"),beta=fit2)
