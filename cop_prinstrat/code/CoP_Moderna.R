...
#dat.mockJ<-read.csv(file="data_clean/janssen_pooled_mock_data_processed.csv")
...
VE2<-integVE.COVID.M(Su,Wu,datin,varlist=c("MinorityInd","HighriskInd","Senior"),beta=fit2)
