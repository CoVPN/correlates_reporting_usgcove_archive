...
load(file=paste0(save.results.to,"outENSEMBLE_boot_",ps,"_",y.v,".Rdata"))
...
plot(outb$Su,outb$VE.S,type='l',ylim=c(0.3,1),xlab="S(1)",ylab="VE(S(1))",main=paste0(ps,',',y.v),xaxt="n", yaxt="n", col="red3", lwd=2.5)
