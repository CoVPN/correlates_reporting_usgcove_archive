...
library(marginalizedRisk) #remotes::install_github("youyifong/marginalizedRisk")
...
for (a in assays) {
    fits.all.2[[a]]=list()        
    fits.all.2[[a]][[1]]=svycoxph(update(form.0, as.formula(paste0("~.+Day",pop, a))), design=design.vacc.seroneg) 
