...
for (a in assays) {
    ...
    for (k in 1:max(dat.mock$Bstratum)) {
        if(sum (subset(dat.vac.seroneg, Bstratum==k, yy))<=2) {
            ...
            design<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=subset(dat.vac.seroneg, Bstratum==k))            
            if (k==1) {
...
for (i in 1:ifelse(study_name_code=="ENSEMBLE",5,4)) {    
    designs[[i]]=list()
    if(i==1) {
        designs[[i]][[1]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, Senior==1)))
        designs[[i]][[2]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, Senior==0)))        
    } else if(i==2) {
        designs[[i]][[1]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, HighRiskInd==1)))
        designs[[i]][[2]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, HighRiskInd==0)))
    } else if(i==3) {
      # MinorityInd also makes sense for US in ensemble
      if(study_name_code=="ENSEMBLE") {          
        designs[[i]][[1]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, MinorityInd==1 & Region==0)))
        designs[[i]][[2]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, MinorityInd==0 & Region==0)))
      } else {
        designs[[i]][[1]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, MinorityInd==1)))
        designs[[i]][[2]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, MinorityInd==0)))
      }
    } else if(i==4) {
        designs[[i]][[1]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, Sex==1)))
        designs[[i]][[2]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, Sex==0)))
    } else if(i==5) {
        designs[[i]][[1]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, HIVinfection==1)))
        designs[[i]][[2]]<-twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, HIVinfection==0)))        
    }
}
...
designs=append(designs, lapply(countries.1, function (i) twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, Country==i)))))
# add Latin America after united states if pooled
if (config$subset_variable=="None") designs = append(designs, lapply(regions[2], function (i) twophase(id=list(~1,~1), strata=list(NULL,~Wstratum), subset=~TwophasesampInd, data=get.dat.with.no.empty(subset(dat.vac.seroneg, Region==i)))), after=2)
