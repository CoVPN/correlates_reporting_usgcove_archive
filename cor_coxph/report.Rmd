...
\begin{figure}[H]
    ...
    \caption{Controlled VE with sensitivity analysis as functions of Day 57 markers among baseline seronegative vaccine recipients with 95\% bootstrap point-wise confidence bands. Histograms of the immunological markers in the vaccine arm are overlaid.}
\end{figure}
