...
***q-value and FWER (family-wide error rate) are computed over the set of p-values both for quantitative markers and categorical markers `r ifelse(study_name_code=="COVE", "(excluding ID80)", "")` using the Westfall and Young permutation method. 
...
$\dagger$ q-value and FWER (family-wide error rate) are computed over the set of p-values both for quantitative markers and categorical markers `r ifelse(study_name_code=="COVE", "(excluding ID80)", "")` using the Westfall and Young permutation method. 
