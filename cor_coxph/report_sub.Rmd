...
Average follow-up of vaccine recipients (in the Day `r Day` correlates analyses population) starting at 7 days post Day `r Day` visit is \input{output/D`r Day`/avg_followup_`r study_name`} days.
