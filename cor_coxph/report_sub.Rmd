...
Cutpoints:
%Day `r Day` cutpoints:
\input{\pathCoRoutput`r Day`/cutpoints_Day`r Day`bindSpike_\studyname},  
\input{\pathCoRoutput`r Day`/cutpoints_Day`r Day`bindRBD_\studyname},  
\input{\pathCoRoutput`r Day`/cutpoints_Day`r Day`pseudoneutid50_\studyname},  
\input{\pathCoRoutput`r Day`/cutpoints_Day`r Day`pseudoneutid80_\studyname}.
%fold-rise cutpoints:
%\input{\pathCoRoutput`r Day`/cutpoints_Delta`r Day`overBbindSpike_\studyname},  
%\input{\pathCoRoutput`r Day`/cutpoints_Delta`r Day`overBbindRBD_\studyname},  
%\input{\pathCoRoutput`r Day`/cutpoints_Delta`r Day`overBpseudoneutid50_\studyname},  
%\input{\pathCoRoutput`r Day`/cutpoints_Delta`r Day`overBpseudoneutid80_\studyname}.  
\\
