...
\\begin{figure}[H]
    ...
    \\caption{Forest plots of hazard ratios per 10-fold increase in the  Day ", Day,  " pseudo neut ID50 markers among baseline negative vaccine recipients (top row) and eight subpopulations (row 2-9) with 95\\% point-wise confidence intervals.}
\\end{figure}
")`
<!-- \begin{figure}[H] -->
<!--     \centering -->
...
\\begin{figure}[H]
    ...
    \\caption{Forest plots of hazard ratios per 10-fold increase in the  Day ", Day,  " pseudo neut ID80 markers among baseline negative vaccine recipients (top row) and eight subpopulations (row 2-9) with 95\\% point-wise confidence intervals.}
\\end{figure}
")`
