...
```{r, fig.cap= paste0('Forest plots of hazard ratios of Day ', Day, ' binding Ab to spike markers among baseline seronegative vaccine recipients (top row) and eight subpopulations (row 2-9) with 95\\% point-wise confidence intervals.')}
...
```{r, fig.cap=paste0('Forest plots of hazard ratios of Day', Day, 'binding Ab to RBD markers among baseline seronegative vaccine recipients (top row) and eight subpopulations (row 2-9) with 95\\% point-wise confidence intervals.')}
...
```{r, fig.cap=paste0('Forest plots of hazard ratios of Day ', Day, ' pseudo neut ID50 markers among baseline seronegative vaccine recipients (top row) and eight subpopulations (row 2-9) with 95\\% point-wise confidence intervals.')}
...
```{r, fig.cap=paste0('Forest plots of hazard ratios of Day ', Day, ' pseudo neut ID80 markers among baseline seronegative vaccine recipients (top row) and eight subpopulations (row 2-9) with 95\\% point-wise confidence intervals.')}
...
```{r, fig.cap = paste0("Controlled VE with sensitivity analysis as functions of Day ", Day, " markers (=s) among baseline seronegative vaccine recipients with 95\\% bootstrap point-wise confidence bands. Histograms of the immunological markers in the vaccine arm are overlaid. lod: lower limit of detection."}
...
```{r, fig.cap = paste0("Marginalized cumulative incidence rate curves for trichotomized Day ", Day, " markers among baseline seronegative vaccine recipients. The gray line is the overall cumulative incidence rate curve in the placebo arm."}
