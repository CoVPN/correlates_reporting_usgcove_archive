...
$^2$E-values are computed for upper tertile ($s=1$) vs. lower tertile ($s=0$) biomarker subgroups after controlling for baseline risk score, at risk or not, community of color or not; UL = upper limit.
\end{table}
