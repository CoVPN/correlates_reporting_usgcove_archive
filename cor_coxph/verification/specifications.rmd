...
\begin{itemize}
    \item If more than the top 1/3 of vaccine recipients have value > ULOQ, use the cut function to cut at the weighted median (Hmisc:wtd.quantile) among those <= ULOQ and ULOQ*.9999; else use the cut function to cut at the 1/3 and 2/3 quantiles (wtd.quantile). (add -Inf and Inf to the beginning and end of the vector of cut points). Convert the results into a factor 
