...
Second, we fit Cox regression models to the following subgroups for continuous markers only. Note that in some subgroups we cannot adjust for all baseline demographic variables. For example, for the at risk subgroup, we cannot include the at-risk indicator. These results will be code-reviewed.
\begin{itemize}
    \item age >= 65
