...
\begin{itemize}
    \item Use Hmisc::wtd.quantile to find cut points at 1/3 and 2/3 quantiles
    \item Add 1e-6 to the first cut point. This helps avoid an error when the first cut point equals the minimum
    \item Add -Inf and Inf to the beginning and end of the vector of cut points. This helps avoid another error in the next step
    \item Use Hmisc::cut2 to trichotomize and convert the results into a factor
