---
title: CoR Plots Verification Documentation
...
The scripts used to generate the original outputs. These live within the `cor_graphical/code` folder.
