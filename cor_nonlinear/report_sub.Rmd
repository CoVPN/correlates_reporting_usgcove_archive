...
Baseline covariates adjusted for: baseline risk score, meeting the protocol randomization stratification criterion for being at heightened risk of COVID (yes or no), `r ifelse(study_name_code=="COVE", "community of color or not", "Region")`. 
