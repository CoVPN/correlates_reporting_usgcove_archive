...
\begin{figure}[H]
    ...
    \caption{Marginalized risk as functions of Day `r tpeak` markers (=s) among baseline seronegative vaccine recipients with 95\% bootstrap point-wise confidence bands (\protect\input{`r pathCoRoutput`/bootstrap_replicates_`r study_name`} replicates) as modeled by GAM with automatic smoothness estimation. 
