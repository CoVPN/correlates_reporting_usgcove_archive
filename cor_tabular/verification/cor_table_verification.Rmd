...
here::i_am("cor_tabular/verification/cor_table_verification.Rmd")
...
dat.mock <- read.csv(here("cor_tabular", "verification","verification_input","practice_data.csv"), stringsAsFactors = F)
dat <- dat.mock
...
load(here("cor_tabular", "verification","verification_input","Tables_cor.Rdata"), verbose=T)
```
...
save(tab_dm_neg_v, file = here::here("cor_tabular", "verification", "verification_output", "cor_tab_dm_neg_v.Rdata"))
save(tab_dm_pos_v, file = here::here("cor_tabular", "verification", "verification_output", "cor_tab_dm_pos_v.Rdata"))
```
...
save(tab_strtm_v, file = here::here("cor_tabular", "verification", "verification_output", "cor_tab_strtm_v.Rdata"))
...
save(case_vacc_neg_v, file = here::here("cor_tabular", "verification", "verification_output", "cor_case_vacc_neg_v.Rdata"))

save(case_vacc_pos_v, file = here::here("cor_tabular", "verification", "verification_output", "cor_case_vacc_pos_v.Rdata"))

save(case_plcb_pos_v, file = here::here("cor_tabular", "verification", "verification_output", "cor_case_plcb_pos_v.Rdata"))
```
