...
# Univariate CoR: Nonparametric Threshold Modeling {#cor-threshold} (>=s)
...
score, high risk indicator, and underrepresented minority status. A parametric
learner, selected via cross-validation, is used for the covariate adjustment. A
