...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{`r here::here("cor_threshold", "figs", paste0("pointwise_CI/PLOT_Day", day, key, "_pointwiseCI.pdf"))`}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{`r here::here("cor_threshold", "figs", paste0("TABLE_Day", day, key, "_pointwiseCI.pdf"))`}
...
\centering
\includegraphics[width=0.9\textwidth]{`r here::here("cor_threshold", "figs", paste0("PLOT_Day", day, key, "_simultCI.pdf"))`}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{`r here::here("cor_threshold", "figs", paste0("TABLE_Day", day, key, "_simultCI.pdf"))`}
...
\centering
\includegraphics[width=0.7\textwidth]{`r here::here("cor_threshold", "figs", paste0("PLOT_monotone_Day", day, key, "_pointwiseCI.pdf"))`}
...
\centering
\includegraphics[width=0.7\textwidth]{`r here::here("cor_threshold", "figs", paste0("PLOT_monotone_Day", day, key, "_simultCI.pdf"))`}
