...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{`r here::here("cor_threshold", "figs", "pointwise_CI", paste0("pointwise_CI/PLOT_Day", day, key, "_pointwiseCI.pdf"))`}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{`r here::here("cor_threshold", "figs", "pointwise_CI", paste0("TABLE_Day", day, key, "_pointwiseCI.pdf"))`}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{`r here::here("cor_threshold", "figs", "simultaneous_CI", paste0("TABLE_Day", day, key, "_simultCI.pdf"))`}
