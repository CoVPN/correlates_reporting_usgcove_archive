...
\begin{itemize}
  ...
  \item Define Wstratum, an integer variable to index strata for computing weights. For Moderna and Janssen, there are 28 strata and 68 strata, respectively. The four additional strata are the cases in placebo/baseline negative, placebo/baseline positive, vaccine/baseline negative, and vaccine/baseline positive, respectively. Notes: a) Some strata may be empty. b) A case will be assigned a stratum from 25 to 28 even if its demo.stratum is NA. 
