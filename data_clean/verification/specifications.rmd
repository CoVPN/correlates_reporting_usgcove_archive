...
\begin{itemize}
  ...
  \item Define wt (and similarly wt.2), a double variable for D57 correlates analyses. The weights equal the sampling probabilities of TwophasesampInd==1 within each Wstratum. This variable is only defined for subjects satisfying EarlyendpointD57==0 & Perprotocol == 1 & EventTimePrimaryD57>=7 and set to NA otherwise. We also set TwophasesampInd to 0 for subjects with NA wt.
