...
\begin{itemize}
  ...
  \item Define wt.subcohort, a double variable. The weights equal the sampling probabilities of TwophasesampInd==1 within each tps.stratum. This variable is only defined for subjects satisfying EarlyendpointD57==0 & Perprotocol == 1 & SubcohortInd and set to NA otherwise
