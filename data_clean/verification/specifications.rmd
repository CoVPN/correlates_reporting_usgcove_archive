...
\begin{itemize}
  ...
  \item Define EarlyendpointD57 (and similarly EarlyendpointD29) as: EarlyinfectionD57==1 | (EventIndPrimaryD1==1 & EventTimePrimaryD1 < NumberdaysD1toD57 + 7),1,0))

  \item Define age.geq.65, a binary variable indicating Age >= 65

  \item Define TwophasesampInd (and similarly TwophasesampInd.2), a 0/1 variable to represent the phase 2 samples for D57 analyses. It is defined as as the intersection of
  \begin{itemize}
    \item EarlyendpointD57==0 & Perprotocol == 1 & EventTimePrimaryD57>=7
    \item either in the subchort or be a case (EventIndPrimaryD29 == 1) (note this is D29 for both TwophasesampInd and TwophasesampInd.2)
