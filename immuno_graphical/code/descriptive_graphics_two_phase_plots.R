...
for (tt in 1:5){
  ...
  for (aa in 1:4) {
    rcdf_list[[aa]] <- ggplot(subset(dat.long.twophase.sample, assay == assays[aa]), aes_string(x = times[tt], colour = "Trt:Bserostatus", weight = "wt")) +
...
for (tt in 1:5){
  rcdf_list <- vector("list", 4)
  for (aa in 1:4) {
    rcdf_list[[aa]] <- ggplot(subset(dat.long.twophase.sample, assay == assays[aa]), 
...
ggplot(subset(dat.long.v2, Trt == "Vaccine"), aes(x = Day29, colour = assay, lty = Bserostatus, weight = "wt")) +
...
ggplot(subset(dat.long.v2, Trt == "Vaccine"), aes(x = Day57, colour = assay, lty = Bserostatus, weight = "wt")) +
  geom_line(aes(y = 1 - ..y..), stat='ecdf', lwd = 1.2) +  theme_pubr() +
  scale_x_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
  scale_color_manual(values = hvtn_col) +
...
png(file = paste0(save.results.to, "Marker_Rcdf_Delta29overB_trt_vaccine_bstatus_both_", 
                  study.name,".png"), height = 640, width = 1020)
ggplot(subset(dat.long.v2, Trt == "Vaccine"), 
...
png(file = paste0(save.results.to, "Marker_Rcdf_Delta57overB_trt_vaccine_bstatus_both_", study.name, ".png"), 
    height = 640, width = 1020)
ggplot(subset(dat.long.v2, Trt == "Vaccine"), aes(x = Delta57overB, colour = assay, lty = Bserostatus, weight = "wt")) +
  geom_line(aes(y = 1 - ..y..), stat='ecdf', lwd = 1.2) +  theme_pubr() +
  scale_x_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
  scale_color_manual(values = hvtn_col) +
...
png(file = paste0(save.results.to, "Marker_Rcdf_Day29_trt_vaccine_bstatus_Neg_", study.name,".png"), 
    height = 640, width = 1020)
ggplot(subset(dat.long.v2, Trt == "Vaccine" & Bserostatus == "Baseline Neg"), aes(x = Day29, colour = assay, weight = "wt")) +
  geom_line(aes(y = 1 - ..y..), stat='ecdf', lwd = 1.2) +  theme_pubr() +
  scale_x_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
  scale_color_manual(values = hvtn_col) +
...
ggplot(subset(dat.long.v2, Trt == "Vaccine" & Bserostatus == "Baseline Neg"), aes(x = Day57, colour = assay, weight = "wt")) +
  geom_line(aes(y = 1 - ..y..), stat='ecdf', lwd = 1.2) +  theme_pubr() +
  scale_x_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
  scale_color_manual(values = hvtn_col) +
...
png(file = paste0(save.results.to, "Marker_Rcdf_Delta29_trt_vaccine_bstatus_Neg_", study.name, ".png"), 
    height = 640, width = 1020)
ggplot(subset(dat.long.v2, Trt == "Vaccine" & Bserostatus == "Baseline Neg"), aes(x = Delta29overB, colour = assay, weight = "wt")) +
  geom_line(aes(y = 1 - ..y..), stat='ecdf', lwd = 1.2) +  theme_pubr() +
  scale_x_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
  scale_color_manual(values = hvtn_col) +
  ylab("Reverse ECDF") + xlab(bquote("Day 29 Fold-rise over Day 1 Binding Ab (IU/ml) / Pseudo nAb ID50 or ID80")) + 
...
png(file = paste0(save.results.to, "Marker_Rcdf_Delta57_trt_vaccine_bstatus_Neg_", study.name,".png"), 
    height = 640, width = 1020)
ggplot(subset(dat.long.v2, Trt == "Vaccine" & Bserostatus == "Baseline Neg"), aes(x = Delta57overB, colour = assay, weight = "wt")) +
  geom_line(aes(y = 1 - ..y..), stat='ecdf', lwd = 1.2) +  theme_pubr() +
  scale_x_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
  scale_color_manual(values = hvtn_col) +
  ylab("Reverse ECDF") + xlab(bquote("Day 57 Fold-rise over Day 1 Binding Ab (IU/ml) / Pseudo nAb ID50 or ID80")) + 
...
for (tt in 2:5) {
  for (bserostatus in 1:2) {
    for (trt in 1:2) {
      subdat <- subset(dat.long.twophase.sample, as.numeric(Bserostatus) == bserostatus &
...
dat.sample1 <- dat.long.twophase.sample[, c("Trt", "Bserostatus", "B", "Day29", "Day57", "Delta29overB", "Delta57overB", "assay")] %>%
...
for (tt in 1:5){
  ...
  for (aa in 1:4) {
    boxplot_list[[aa]] <- ggplot(subset(dat.long.twophase.sample, assay == assays[aa]), aes_string(x = "Trt", y = times[tt])) +
      ...
      geom_jitter(data = subset(dat.sample1, assay == assays[aa]), mapping = aes(colour = Trt:Bserostatus), width = 0.1, size = 5) +
...
for (bstatus in 1:2) {
  for (tt in 1:5){
    boxplot_list <- vector("list", 4)
    for (aa in 1:4) {
      boxplot_list[[aa]] <- ggplot(subset(dat.long.twophase.sample, assay == assays[aa] & Bserostatus == bstatus.labels[bstatus]), 
        ...
        guides(alpha = "none", fill = "none") +
        geom_jitter(data = subset(dat.sample1, assay == assays[aa] & Bserostatus == bstatus.labels[bstatus]), mapping = aes(colour = Trt), width = 0.1, size = 5) +
        scale_y_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
        theme_pubr(legend = "none") + 
        ylab(labels.axis[tt, aa]) + xlab("") + 
        scale_fill_manual(values = hvtn_col) +
...
for (tt in 1:5){
  boxplot_list <- vector("list", 4)
  for (aa in 1:4) {
    boxplot_list[[aa]] <- ggplot(subset(dat.long.twophase.sample, assay == assays[aa]), aes_string(x = "Bserostatus", y = times[tt])) +
      geom_boxplot(aes(colour = Trt:Bserostatus), width = 0.6, lwd = 1.5) + 
      stat_boxplot(aes(colour = Trt:Bserostatus), geom = "errorbar", width = 0.45, lwd = 1.5) +
      guides(alpha = "none", fill = "none") +
      geom_jitter(data = subset(dat.sample1, assay == assays[aa]), mapping = aes(colour = Trt:Bserostatus), width = 0.1, size = 5) +
...
for (trt in 1:2) {
  for (tt in 1:5){
    boxplot_list <- vector("list", 4)
    for (aa in 1:4) {
      boxplot_list[[aa]] <- ggplot(subset(dat.long.twophase.sample, assay == assays[aa] & as.numeric(Trt) == trt), aes_string(x = "Bserostatus", y = times[tt])) +
        ...
        guides(alpha = "none", fill = "none") +
        geom_jitter(data = subset(dat.sample1, assay == assays[aa] & as.numeric(Trt) == trt), mapping = aes(colour = Bserostatus), width = 0.1, size = 5) +
        scale_y_continuous(limits = c(-2, 10), labels = label_math(10 ^ .x), breaks = seq(-2, 10, 2)) +
        theme_pubr(legend = "none") + 
        ylab(labels.axis[tt, aa]) + xlab("") + 
        scale_fill_manual(values = hvtn_col) +
