...
pairplots <- covid_corr_pairplots_for_verification(
        ...
        column_labels = labels.axis[3, seq_along(assays)] %>% unlist()
      )
...
corr_mat <- data.frame(x = c("bindRBD", "pseudoneutid50", "pseudoneutid80", "pseudoneutid50", "pseudoneutid80", "pseudoneutid80"),
                       y = c("bindSpike", "bindSpike", "bindSpike", "bindRBD", "bindRBD", "pseudoneutid50"),
                       corr = cor_res)
