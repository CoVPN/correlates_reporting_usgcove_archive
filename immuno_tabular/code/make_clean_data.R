...
subgrp <- c("Total"="All participants", "Age65C"="Age", "HighRiskC"="Risk for Severe Covid-19", "AgeRiskC"="Age, Risk for Severe Covid-19", 
...
ds3<- bind_cols(
  ds2, 
  pmap(list(data=replicate(length(c(bAb, pnAb, lnAb)), ds2, simplify = F),
            t1="B", 
            t2="Day57", 
