...
cps=c("Age","Age, Risk for Severe Covid-19","Age, Risk for Severe Covid-19","Sex","Hispanic or Latino ethnicity", VarName_levels[["MinorityC"]], "Risk for Severe Covid-19")
group1=c(older_age, paste(younger_age, "At-risk"), paste(older_age,  "At-risk"), "Male", "Hispanic or Latino", minortiy_grp1, "At-risk")
group2=c(younger_age, paste(younger_age, "Not at-risk"), paste(older_age, "Not at-risk"), "Female", "Not Hispanic or Latino", minortiy_grp2, "Not at-risk")
...
for (cp in c("Arm","Baseline SARS-CoV-2", "Age","Age, Risk for Severe Covid-19","Age, Risk for Severe Covid-19","Sex","Hispanic or Latino ethnicity",VarName_levels[["MinorityC"]],"Risk for Severe Covid-19")){
  for (mk in c("Anti N IgG (IU/ml)","Anti RBD IgG (IU/ml)","Anti Spike IgG (IU/ml)"
               #,"Pseudovirus-nAb ID50","Pseudovirus-nAb ID80"
               )){
    for (tp in two_timepoints){
    ...
    comp1 <- ifelse(cp=="Arm", "Vaccine", 
                    ifelse(cp=="Baseline SARS-CoV-2", "Positive",
                           ifelse(cp=="Age", older_age, 
                                  ifelse(cp=="Risk for Severe Covid-19", "At-risk",
                                         ifelse(cp=="Age, Risk for Severe Covid-19" & ind_comp==4, paste(younger_age,"At-risk"),
                                                ifelse(cp=="Age, Risk for Severe Covid-19" & ind_comp==5, paste(older_age,"At-risk"),
                                                       ifelse(cp=="Sex","Male",
                                                              ifelse(cp=="Hispanic or Latino ethnicity","Hispanic or Latino",ifelse(cp==VarName_levels[["MinorityC"]], minortiy_grp1, NA)))))))))
    
    comp2 <- ifelse(cp=="Arm", "Placebo", 
                    ifelse(cp=="Baseline SARS-CoV-2", "Negative",
                           ifelse(cp=="Age", younger_age, 
                                  ifelse(cp=="Risk for Severe Covid-19", "Not at-risk",
                                         ifelse(cp=="Age, Risk for Severe Covid-19" & ind_comp==4, paste(younger_age, "Not at-risk"),
                                                ifelse(cp=="Age, Risk for Severe Covid-19" & ind_comp==5, paste(older_age, "Not at-risk"),
                                                       ifelse(cp=="Sex","Female",
                                                              ifelse(cp=="Hispanic or Latino ethnicity","Not Hispanic or Latino",ifelse(cp==VarName_levels[["MinorityC"]], minortiy_grp2, NA)))))))))
