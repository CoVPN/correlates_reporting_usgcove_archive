...
dat$immuno_ind <- with(dat, ifelse(Perprotocol==1 & SubcohortInd==1 & TwophasesampInd==1 & !is.na(wt.subcohort), 1, 0))
...
load(here("verification","Tables_verificatiton_immuno.Rdata"))
