...
```{r setup, include=FALSE, echo=FALSE}
  here::i_am("immuno_tabular/verification/immuno_table_verification.Rmd")
  library(tidyverse)
  library(Hmisc)
  library(survey)
...
dat.mock <- read.csv(here("immuno_tabular", "verification","verification_input", data_in_file), stringsAsFactors = F)
...
load(here("immuno_tabular", "verification","verification_input","Tables_immuno.Rdata"), verbose=T)
...
for (i in c("Positive", "Negative")){
  ...
  tab_dm <- tab_dm %>% select(1,2,4,3,5)
   ...
   if (i=="Positive"){
    ...
    save(tab_dm_pos_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_dm_pos_v.Rdata"))
  } else if (i=="Negative"){
    # comparison
    ...
    save(tab_dm_neg_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_dm_neg_v.Rdata"))
  }
}
```
...
for (i in list(c(1:8), c(9:16))){
    ...
    save(tab_strtm1_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_strtm1_v.Rdata"))
    } else if (i==c(9:16)){
    ...
    save(tab_strtm2_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_strtm2_v.Rdata"))
    }
}
```
...
save(tab_bind1_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_bind1_v.Rdata"))
```
...
save(tab_bind2_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_bind2_v.Rdata"))
...
if (c("Pseudovirus-nAb ID50","Pseudovirus-nAb ID80") %in% unique(dat.long$marker)){
  ...
  save(tab_pseudo_sub_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_pseudo_v.Rdata"))
}
...
save(tab_gm_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_gm_v.Rdata"))
```
...
save(tab_gmr_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_gmr_v.Rdata"))
```
...
save(tab_rgmt_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_rgmt_v.Rdata"))
```
...
save(tab_rrdiff_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_rrdiff_v.Rdata"))
```
...
for (i in c("Negative", "Positive")){
  ...
  save(tab_neg_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_neg_v.Rdata"))
  } else if (i=="Positive"){
  ...
  save(tab_pos_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_pos_v.Rdata"))
...
for (i in c("Vaccine", "Placebo")){
  ...
  save(tab_vacc_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_vacc_v.Rdata"))
  } else if (i=="Placebo"){
  ...
  save(tab_plcb_v, file = here::here("immuno_tabular", "verification", "verification_output", "immuno_tab_plcb_v.Rdata"))
  }
}
