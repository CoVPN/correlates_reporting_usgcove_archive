...
header-includes:
   - \usepackage{eso-pic,graphicx,transparent,caption,pdflscape}
   - \usepackage[margin=1in]{geometry}
---


```{r, include = knitr::is_latex_output() & grepl("Mock", study_label, ignore.case = TRUE)}
...
`r if (attr(config::get(config = Sys.getenv("TRIAL")), "config") != "moderna_real") '<!--'`
...
` if (attr(config::get(config = Sys.getenv("TRIAL")), "config") != "moderna_real") '-->'`
